...
public class MenuLivros {
  ...
  public void menu() {
    ...
    do {
      ...
      System.out.println("3) Busca livro lista");
      System.out.println("4) Altera livro");
      System.out.println("5) Exclui livro");
  ...
  public void buscarLivroLista() {
    ...
    try {
      List<Livro> l = arqLivros.buscarLivrosPorTermos(titulo);
      if (l == null) {
        System.out.println("Livro não encontrado.");
        return;
      }
